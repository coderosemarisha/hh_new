...
base_url = 'https://hh.ru/search/vacancy?search_period=3&clusters=true&area=77&text=python&enable_snippets=true&page=0'
    ...
    if request.status_code == 200:
        ...
        try:
            ...
            for i in range(count):
                url = f'https://hh.ru/search/vacancy?search_period=3&clusters=true&area=77&text=python&enable_snippets=true&page={i}'
                if url not in urls:
                    urls.append(url)
        except:
            pass
